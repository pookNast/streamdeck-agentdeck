...
class Config:
    ...
    def weather_city_name(self):
        ...
        return self._get("weather.city_name", "Your City")
    ...
    def monitor_hosts(self):
        """SSH host aliases to health-check on the touchscreen. Empty list disables monitoring."""
        return self._get("monitor.hosts", [])
